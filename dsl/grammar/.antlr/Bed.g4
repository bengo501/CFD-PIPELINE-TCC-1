...
section: bedSection  // secao bed 
       | lidsSection  // secao lids 
       | particlesSection  // secao particles
       | packingSection  // secao packing
       | exportSection  // secao export
       | cfdSection; // secao cfd

// secao bed: define geometria do leito cilindrico
bedSection: 'bed' '{' bedProperty+ '}';
bedProperty: 'diameter' '=' NUMBER UNIT ';'         # bedDiameter // diametro do leito
           | 'height' '=' NUMBER UNIT ';'           # bedHeight  
           | 'wall_thickness' '=' NUMBER UNIT ';'   # bedWallThickness//espessura da parede do leito
           | 'clearance' '=' NUMBER UNIT ';'        # bedClearance // clearance do leito
           | 'material' '=' STRING ';'              # bedMaterial // material do leito
...
//comentários: comentarios de linha e blocos de comentarios
